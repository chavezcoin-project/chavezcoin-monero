...
* Running chavezcoin node, linked to private/public testnet. 
  ...
  [Manual](https://github.com/chavezcoinexamples/private-testnet) explaining how to run private testnet.
...
* Directory with pre-generated wallets
  ...
  By default, tests expect these wallets to be in ```/var/chavezcoin/testnet_pvt```. 
